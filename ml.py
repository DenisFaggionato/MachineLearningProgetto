...
def rileva_oggetti(img, classificatori):
    ...
    for classificatore, nome_vestito in classificatori:
        spazio = classificatore.detectMultiScale(img, scaleFactor=1.1, minNeighbors=150)
        elementi = len(spazio)
...
def main():
    classificatori = [
        ...
        (cv.CascadeClassifier("File xml cascade\MEN-Tees_Tanks.xml"), "Maglia"),
        ...
        (cv.CascadeClassifier("File xml cascade\WOMEN-Tee_Tanks1.xml"), "Maglia"),
    ]
